...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.act_splash).postDelayed(new Runnable() {
            @Override
            public void run() {
                // Find and hide the loading screen
                View loadingView = findViewById(R.id.item_loading);
                if (loadingView != null) {
                    loadingView.setVisibility(View.GONE); // Hide the loading screen
                }
            }
        }, 3000);
