...
StoryAdapter adapter;
    ...
    private void initData(){
        ...
        storyList.add(new Story(R.drawable.ic_launcher_foreground, "title5", "author5", "cocntext5"));
        storyList.add(new Story(R.drawable.ic_launcher_foreground, "title6", "author6", "cocntext6"));
        storyList.add(new Story(R.drawable.ic_launcher_foreground, "title7", "author7", "cocntext7"));
        storyList.add(new Story(R.drawable.ic_launcher_foreground, "title8", "author8", "cocntext8"));
        storyList.add(new Story(R.drawable.ic_launcher_foreground, "title9", "author9", "cocntext9"));
